...
export default function SuccessPage(){
    ...
    return (
        <main className="w-full px-10 h-screen bg-neutral flex flex-col items-center justify-center">
            <div className=" flex flex-col gap-4  p-8  rounded-lg bg-secondary items-center text-center">
                ...
                <h2 className="text-neutral text-md font-semibold">{t('subtitle')}</h2>
                <p className="text-neutral font-semibold">{t('text')}</p>
            </div>
            <Link href={`/`}><button className="btn btn-primary hover:btn-secondary mt-8 text-neutral">{t('btn-text')}</button></Link>
        </main>
    )
}
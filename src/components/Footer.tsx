...
function Footer() {
  ...
  return (
    ...
    <ul className="flex justify-evenly gap-4 items-center col-start-1 col-end-5 text-[0.75rem]  h-2 row-start-3 row-end-4 font-semibold cursor-pointer">
    ...
    <h2 className="text-lg lg:text-xl col-start-2 col-end-4 row-start-4 row-end-5 font-bold h-2 m-0">{t('subtitle')}</h2>
    <div className="flex items-center justify-center col-start-1 col-end-5 row-start-7 gap-6 text-lg mt-8">

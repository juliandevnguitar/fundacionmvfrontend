...
export default function AboutContent({translations} : {translations: translations}){
    ...
    return (
        <div className="w-full grid grid-cols-3 justify-items-center items-center gap-8 ">
                <motion.h2 initial={{translateY: 200, opacity: 0}} whileInView={{translateY: 0, opacity: 1}} transition={{type: 'tween', duration: 0.8}} viewport={{once: true, amount: 0.8}}
                className="col-start-1 col-end-4  text-secondary text-xl lg:text-3xl font-bold mb-8">{translations.aboutTitle}</motion.h2>
                <motion.p initial={{translateY: 200, opacity: 0}} whileInView={{translateY: 0, opacity: 1}} transition={{type: 'tween', duration: 0.8}} viewport={{once: true, amount: 0.8}}
                ...
                <motion.img initial={{translateY: 200, opacity: 0}} whileInView={{translateY: 0, opacity: 1}} transition={{type: 'tween', duration: 0.8}} viewport={{once: true, amount: 0.8}}
                ...
                <motion.h3  initial={{translateY: 200, opacity: 0}} whileInView={{translateY: 0, opacity: 1}} transition={{type: 'tween', duration: 0.8}} viewport={{once: true, amount: 0.8}}
